...
speakerSection.innerHTML = `
    ...
    <div class="featured-grid">
        <div class="row mt-5 mt-lg-0">
            <div class="col col-4">
                <img src="images/Aileen-Lee.png" alt="featured speaker" srcset="">
            </div>
            <div class="col col-8">
                <h4>${speaker1.name}</h4>
...
featuredSpeakersGridTwo.innerHTML = `
    <div class="featured-grid featured-grid-two">
        <div class="row">
            <div class="col col-4">
                <img src="images/RJ-Scavinge.png" alt="featured speaker" srcset="">
            </div>
        <div class="col col-8">
            <h4>${speaker3.name}</h4>
        ...
        <div class="col col-4">
            <img src="images/Serena-Williams.png" alt="featured speaker" srcset="">
        </div>
        <div class="col col-8">
            <h4>${speaker4.name}</h4>
